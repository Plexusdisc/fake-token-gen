...
token = input("Enter the token you want to check: ")
    #"MTA3MjAxNzEyOTczOTY2NTQ4OQ.GUogb2.ZnaNDmEfd_XBLa1byzZ6UL1rLuYqc4lcrh9uyY"
...
print("\n".join(f"{key}: {value}" for key, value in client.json().items()))
client_dict = client.json()

print(Fore.RED+"------------ Public account info ------------")
...
if client_dict['bio'] == " " or client_dict['bio'] == "":
    print(Fore.RED+"This user has no bio")
else:
